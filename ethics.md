...
<div style="margin: 24px 0;">
	<button onclick="window.location.href='cases/ethics-cases'" style="padding: 12px 28px; font-size: 15px; font-weight: 600; background-color: #ff6600; color: white; border: none; border-radius: 6px; cursor: pointer;">
